...
namespace TimeCalculator.UnitTests.Models
{
    public class TimeConverterTests
    {
        ...
        [InlineData("9.6", ETimeUnit.Hour, ETimeUnit.Year, "0.00109589")]
        ...
        [InlineData("0.743", ETimeUnit.Week, ETimeUnit.Year, "0.014249315")]
        [InlineData("0.001", ETimeUnit.Year, ETimeUnit.MicroSecond, "31536000000")]
        [InlineData("0.001", ETimeUnit.Year, ETimeUnit.MilliSecond, "31536000")]
        [InlineData("0.001", ETimeUnit.Year, ETimeUnit.Second, "31536")]
        [InlineData("0.001", ETimeUnit.Year, ETimeUnit.Minute, "525.6")]
        [InlineData("0.001", ETimeUnit.Year, ETimeUnit.Hour, "8.76")]
        [InlineData("0.001", ETimeUnit.Year, ETimeUnit.Day, "0.365")]
        [InlineData("0.001", ETimeUnit.Year, ETimeUnit.Week, "0.052142857")]
